...
public class CashierinterfaceDontInclude extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CashierinterfaceDontInclude frame = new CashierinterfaceDontInclude();
	 ...
	 * Create the frame.
	 */
	public CashierinterfaceDontInclude() {
		setResizable(false);
		...
		MenuItemAddProd.addActionListener(e -> {
		    AddProductFrameDontInclude addFrame = new AddProductFrameDontInclude();
		    addFrame.setVisible(true);
				...
				MenuItemStoreIncome.addActionListener(e -> {
				    StoreIncomeFrameDontInclude incomeFrame = new StoreIncomeFrameDontInclude();
		...
		MenuItemStockMonitor.addActionListener(e -> {
		    StockMonitoringFrameDontInclude stockFrame = new StockMonitoringFrameDontInclude();
